...
class XMLReader:
    ...
    def get_objects(self):
        objects = []
        # print('self.root.findall("object")',self.root.findall("object"))
        for object in self.root.findall("object"):
            objects.append({
                "name" : object.find("name").text,
                "xmin" : object.find("hbox").find("bndbox").find("xmin").text,
                "ymin" : object.find("hbox").find("bndbox").find("ymin").text,
                "xmax" : object.find("hbox").find("bndbox").find("xmax").text,
                "ymax" : object.find("hbox").find("bndbox").find("ymax").text
            })
